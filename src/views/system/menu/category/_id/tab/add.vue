      ...
      >
        ...
        <div>
          <ValidationObserver v-slot="{ handleSubmit }">
            <form @submit.prevent="handleSubmit(categoryAdd)">
                ...
                <div class="rounded-t mb-0 px-4 py-3 border bg-gray-300">
                  <div class="flex flex-wrap items-center justify-between">
                    ...
                    >
                      ...
                      >
                      <span class="px-2 text-red-500 text-xs font-bold">
                        *對應欄位 : default_type ; 對應後台system、admin權限。
                      </span>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    categoryAdd() {
      ...
      this.$api.serviceMenuCategoryIdTabAdd(this.$route.params.id,params).then((element) => {
        if (element) {
          this.$router.go(-1);
        }
      });
